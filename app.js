...
var config = {
    apiKey: "AIzaSyDNkRKiA7NMTiIVe-scwavaDWz8c1rKhzo",
    authDomain: "rps-multiplayer-71b75.firebaseapp.com",
    databaseURL: "https://rps-multiplayer-71b75.firebaseio.com",
    projectId: "rps-multiplayer-71b75",
    storageBucket: "rps-multiplayer-71b75.appspot.com",
    messagingSenderId: "26533620459"
  };
...
playersRef.on("value", function(snapshot) {
  ...
  if (playerOneExists) {
    ...
    $("#player1-wins").text("W: " + playerOneData.wins);
    $("#player1-losses").text("L: " + playerOneData.losses);
  }
  else {

    // If there is no player 1, clear win/loss data and show waiting
    $("#player1-name").text("Waiting for Player");
    $("#player1-wins").empty();
  ...
  if (playerTwoExists) {
    ...
    $("#player2-wins").text("W: " + playerTwoData.wins);
    $("#player2-losses").text("L: " + playerTwoData.losses);
  }
  else {

    // If no player 2, clear win/loss and show waiting
    $("#player2-name").text("Waiting for Player");
    $("#player2-wins").empty();
